...
//    sprintf(UID_BUF, "%08X", DBGMCU_GetCHIPID());
//    memcpy((unsigned char*)str, UID_BUF, sizeof(UID_BUF));
//    return sizeof(UID_BUF);
    uint32_t IC_UID;
    IC_UID = *(uint32_t*)0x1FFFF7E8 & 0x0001FFFF;                                                     //????0~16¦Ë,17¦Ë?????¦·??????0~16¦Ë
    IC_UID |= (((*(uint32_t*)(0x1FFFF7E8)) & (0x0000000F << 28)) >> 28 << 17);        //?28??31¦Ë??4¦Ë ?????17-20
    IC_UID |= (((*(uint32_t*)(0x1FFFF7E8 + 4)) & 0x00000003) << 21);                          //?32~33??2¦Ë?????21~22
    IC_UID |= ((((*(uint32_t*)(0x1FFFF7E8 + 8)) & (0x000001FF << 15)) >> 15) << 23);  //????9¦Ë,???¦·??????23~31
